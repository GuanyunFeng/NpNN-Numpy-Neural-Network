...
观察前向传播中的图二不难发现，做矩阵乘法后有![](http://latex.codecogs.com/svg.latex?h_{ij}=\sum_{k}{x_{jk}w_{ki}}), 因此有![](http://latex.codecogs.com/svg.latex?\\frac{\\partial{J}}{\\partial{w_{ij}}}=\\sum_{k}{})。
